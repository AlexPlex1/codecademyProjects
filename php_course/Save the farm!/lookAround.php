  ...
  if ($wearing_glasses xor $wearing_contacts){
    switch ($location){
      case "kitchen":
        ...
        if ($moved_cupboard) echo "The cupboard has been moved aside, and reveals a safe built in to the wall.\n";
        else echo "Also, there's a conspicuously large cupboard against a peculiarly worn piece of the wall.\n";
        break;
      case "bathroom":
